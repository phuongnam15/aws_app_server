...
const getDashboardMetrics = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const expenseByCategorySummary = expenseByCategorySummaryRaw.map((expense) => (Object.assign(Object.assign({}, expense), { amount: expense.amount.toString() })));
        res.json({
            popularProducts,
            salesSummary,
            purchaseSummary,
        ...
        res.status(500).json({ error: "Error retreiving dashboard metrics" });
    }
});
